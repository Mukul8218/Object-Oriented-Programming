...
class Demo:
    a= 100
    def myFun(self):
        print("I am in class demo and my name is myFun",self.a)
...
emp1=Emp()
emp2=Emp()
emp1.setEmp(102,"Mukul",23454,"Google")
emp1.displayEmp()
print("--------------------------------------------------")
emp2.setEmp(103,"Ritz",65432,"Google")
emp2.displayEmp()
print("-------------------------------------------------------")
